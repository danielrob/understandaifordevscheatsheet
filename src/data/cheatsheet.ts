export interface CheatSheetItem {
  ...
  title: string;
  content: string;
  type: 'concept' | 'technical' | 'framework';
}
...
export const cheatSheetData: CheatSheetItem[] = [
  {
    id: 'basic-models',
    title: 'Basic models',
    content: 'i/o. "ChatGPT moment" style models. Now: "Fast" models. Input prompt, generates response. Single-shot, multi-shot prompting (see prompt engineering). How do they work? See Models & Inference. See also: Reasoning models, Model Systems.',
    type: 'concept'
  },
  {
    id: 'models-inference',
